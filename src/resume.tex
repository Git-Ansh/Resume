...
\geometry{left=1.15cm, top=.6cm, right=1.15cm, bottom=0.4cm, footskip=.5cm}
...
% \definecolor{russell}{HTML}{3F00FF}
...
% \medium{madium-id}
% \kaggle{kaggle-id}
\googlescholar{YNn0HkUAAAAJ}{Google Scholar}
